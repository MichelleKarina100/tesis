...
class GameSumaView( TemplateView):
    template_name = 'juegoSuma/juegosuma.html'

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Juego de Sumas'
        return context


class GameSumaOperacionesView( TemplateView):
    template_name = 'juegoOperaciones/operaciones.html'
